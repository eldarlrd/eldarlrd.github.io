...
- **Frontend Development** — I craft responsive, accessible, and elegant web apps using React, TypeScript, and modern tooling.
...
- **Free & Open Source Software** — I believe in free software and love tinkering with Linux-based environments.
...
- 🤺 Recently into cars and languages; because why not?

## 🛠️ Tech Stack

- **Languages**: JavaScript / TypeScript, HTML, CSS, C#, Python, R
- **Frameworks & Tools**: React, Next.js, Tailwind, Vite, Git, Node
- **Other**: Linux (daily driver), WebStorm, Figma, browser dev tools like a second brain
